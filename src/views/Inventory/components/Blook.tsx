...
export default function Blook({ blook, locked, quantity, ...props }: BlookProps) {
    ...
    return (
        <div data-locked={locked} className={styles.blook} {...props}>
            <ImageOrVideo src={!locked ? (resourceIdToPath(blook.imageId) || "https://cdn.blacket.org/static/content/blooks/Error.png") : "https://cdn.blacket.org/static/content/blooks/Default.png"} data-locked={locked} alt={blook.name} draggable={false} />
            {!locked && <div style={{
